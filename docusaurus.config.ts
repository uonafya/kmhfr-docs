...
const config: Config = {
  ...
  url: 'https://kmhfltest.health.go.ke',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/uonafya/kmhfr-docs',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      //   },
      // ],
      copyright: `Copyright © ${new Date().getFullYear()} Ministry of Health, Goverment of Kenya. Kenya Master Health Facility Registry Docs `,
    },
    prism: {
